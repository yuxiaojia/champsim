...
(./bin/${BINARY} -warmup_instructions ${N_WARM}000000 -simulation_instructions ${N_SIM}000000 ${OPTION} -traces ${TRACE_DIR}/${TRACE0} ${TRACE_DIR}/${TRACE1} ${TRACE_DIR}/${TRACE2} ${TRACE_DIR}/${TRACE3}) &> myout${N_SIM}M/mix${N_MIX}-${BINARY}${OPTION}${TRACE0}${TRACE1}${TRACE2}${TRACE3}.txt
